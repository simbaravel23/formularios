...
const FormularioApartamento = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input type="text" name="condominio" placeholder="Condomínio" onChange={handleChange} />
      <input type="number" name="areaPrivativa" placeholder="Área Privativa" onChange={handleChange} />
      <input type="number" name="areaComum" placeholder="Área Comum" onChange={handleChange} />
...
export default FormularioApartamento;